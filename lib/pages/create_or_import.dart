...
import 'package:temp_project/pages/generate_mnemonic.dart';
import 'package:temp_project/pages/import_wallet.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor:
                    Color.fromARGB(255, 7, 226, 175), // Customize button background color
